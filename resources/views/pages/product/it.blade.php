@extends('layouts.app')
@section('content')
@section('title', 'IT Media & Software Solution')
<!-- Breadcrumb Begin -->
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcrumb__option">
                    ...
                    <span>IT Media & Software Solution</span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="blog__hero__text">
                    <div class="label" style="background: #af0e71">Produk</div>
                    <h2 style="font-weight: bold">IT Media & Software <br>
                        Solution
                    </h2>
                    <ul>
            ...
            <div class="col-lg-12">
                <div class="blog__details__text">
                    <div class="blog__details__profile"
                        style="background: #af0e71; box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px; border-radius:10px; margin:0">
                        <div class="blog__details__profile__text">
                            <p style="font-size: 20px; color:white">Rampingkan operasional Anda dengan solusi TI khusus
                                kami. Mari tingkatkan efisiensi operasional JXB melalui solusi TI mutakhir.
                                Mulai dari otomatisasi tugas rutin hingga optimalisasi manajemen data, solusi kami akan
                                memberdayakan tim Anda untuk fokus pada hal yang benar-benar penting: memberikan
                                pengalaman yang tak terlupakan kepada pengunjung. Bayangkan masa depan di mana pemesanan
                                menjadi lebih lancar, data pelanggan mudah diakses, dan tim Anda lebih terhubung dari
                                sebelumnya.</p>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                ...
                <hr style="border: 5px solid #af0e71; border-radius:10px; opacity:1; width:10%; margin-bottom: 20px"
                    class="mx-auto">
            </div>
        </div>
        <div class="row">
            <div class="col-lg-4 col-md-12 col-sm-12">
                <div class="feature__item">
                    <span class="fa fa-cloud" style="color: #af0e71"></span>
            ...
            <div class="col-lg-4 col-md-12 col-sm-12">
                <div class="feature__item">
                    <span class="fa fa-server" style="color: #af0e71"></span>
            ...
            <div class="col-lg-4 col-md-12 col-sm-12">
                <div class="feature__item">
                    <span class="fa fa-clock-o" style="color: #af0e71"></span>
                        ...
                        <div class="tab-pane active" id="tabs-1" role="tabpanel">
                            <div class="hosting__feature__table">
                                <table>
                                        ...
                                        <tr>
                                            <th colspan="2">
                                                <div class="hosting__feature__plan--choose"
                                                    style="padding: 20px; background: #af0e71">
                                                    <span style="color: white">Kami Menyediakan Jasan Pembuatan &
                                                        Konsultasi </span>
                                                    <div class="chose__title" style="color: white"> IT
                                                        Media & Software
                                                        Solution
                                                    </div>
                                                </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="hosting__feature--item">Pengembangan dan Pemeliharaan Website /
                                                Aplikasi
                                            </td>
                                        ...
                                        <tr>
                                            <td class="hosting__feature--item">Sistem Manajemen Konten (CMS)</td>
                                            <td class="hosting__feature--check">
                                                <span class="fa fa-check-circle-o"></span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="hosting__feature--item">Optimasi SEO</td>
                                            <td class="hosting__feature--check">
                                                <span class="fa fa-check-circle-o"></span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="hosting__feature--item">Layanan Mail</td>
                                            <td class="hosting__feature--check">
                                                <span class="fa fa-check-circle-o"></span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="hosting__feature--item">Dukungan dan Pemeliharaan TI</td>
                                            <td class="hosting__feature--check">
                                                <span class="fa fa-check-circle-o"></span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="hosting__feature--item">Aplikasi Media Digital</td>
                                            <td class="hosting__feature--check">
                                                <span class="fa fa-check-circle-o"></span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="hosting__feature--item">Dan Lainnya</td>
                                            <td class="hosting__feature--check">
                                                <span class="fa fa-check-circle-o"></span>
                                            </td>
                                        </tr>
